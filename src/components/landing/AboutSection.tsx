...
export function AboutSection() {
  ...
  return (
    <section id="nosotros" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 lg:mb-16">
          <Card className="p-4 sm:p-6 lg:p-8 hover:shadow-lg transition-shadow">
            <div className="bg-yellow-100 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
              <Target className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-yellow-600" />
            </div>
          ...
          <Card className="p-4 sm:p-6 lg:p-8 hover:shadow-lg transition-shadow">
            <div className="bg-yellow-100 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-lg flex items-center justify-center mb-4 sm:mb-6">
              <Eye className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-yellow-600" />
            </div>
        ...
        <div className="mb-8 sm:mb-12 lg:mb-16">
          <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl sm:rounded-2xl p-4 sm:p-8 md:p-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            <div className="text-center">
              <div className="bg-yellow-100 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Heart className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-yellow-600" />
              </div>
              <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">Pasión</h4>
            ...
            <div className="text-center">
              <div className="bg-yellow-100 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Award className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-yellow-600" />
              </div>
              <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">Excelencia</h4>
              <p className="text-xs sm:text-sm lg:text-base text-gray-600">
            ...
            <div className="text-center">
              <div className="bg-yellow-100 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Users className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-yellow-600" />
              </div>
              <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">Colaboración</h4>
              <p className="text-xs sm:text-sm lg:text-base text-gray-600">
            ...
            <div className="text-center">
              <div className="bg-yellow-100 w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <Globe className="h-6 w-6 sm:h-7 sm:w-7 lg:h-8 lg:w-8 text-yellow-600" />
              </div>
              <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 mb-1 sm:mb-2">Innovación</h4>
              <p className="text-xs sm:text-sm lg:text-base text-gray-600">
        ...
        {/* Team Stats */}
        <div className="mt-8 sm:mt-12 lg:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 text-center">
          <div>
            <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-yellow-500 mb-1 sm:mb-2">{(activeCompanies ? activeCompanies + "+" : false) || '...'}</p>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Empresas Activas</p>
          </div>
          <div>
            <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-yellow-500 mb-1 sm:mb-2">30+</p>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Usuarios Diarios</p>
          </div>
          <div>
            <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-yellow-500 mb-1 sm:mb-2">99.9%</p>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Uptime</p>
          </div>
          <div>
            <p className="text-2xl sm:text-3xl lg:text-4xl font-bold text-yellow-500 mb-1 sm:mb-2">24/7</p>
            <p className="text-xs sm:text-sm lg:text-base text-gray-600">Soporte</p>
          </div>
        </div>
      </div>
    </section>
