  ...
  "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-gray-950 dark:focus-visible:ring-gray-800",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-gray-600 bg-transparent text-gray-600 hover:bg-gray-100/10 hover:text-gray-900 dark:border-gray-300 dark:text-gray-300 dark:hover:bg-gray-800/20 dark:hover:text-gray-100",
        secondary:
          "bg-secondary text-white hover:bg-secondary-700 dark:bg-secondary-800 dark:text-white dark:hover:bg-secondary-700",
